...
const MapModule = (() => {
  ...
  const UMBRAL_ZOOM_ETIQUETA = 15; // desde este zoom (~escala 1:25.000) se muestra el código de la UA
  ...
  async function inicializarCapaUA() {
    ...
    geojson.features.forEach(feature => {
      ...
      // de UMBRAL_ZOOM_ETIQUETA (ver actualizarVisibilidadEtiquetasUA).
