...
const CONFIG = {
  ...
  // Opciones para el filtro de categoría del coroplético (columna derecha):
  // el total general, el total de cada grupo, y cada una de las 8 categorías.
  OPCIONES_COROPLETICO: [
    { id: 'total', label: 'Total de alertas (A45I3 + A46I3)' },
    { id: 'a45i3_total', label: 'Total Gestantes (A45I3)' },
    { id: 'a46i3_total', label: 'Total Niños y Niñas (A46I3)' },
    { id: 'muy_alta1', label: 'Gestantes · Muy Alta 1' },
    { id: 'alta1', label: 'Gestantes · Alta 1' },
    { id: 'alta3', label: 'Gestantes · Alta 3' },
    { id: 'muy_alta2', label: 'Niños/Niñas · Muy Alta 2' },
    { id: 'alta2', label: 'Niños/Niñas · Alta 2' },
    { id: 'alta4', label: 'Niños/Niñas · Alta 4' },
    { id: 'alta5', label: 'Niños/Niñas · Alta 5' },
    { id: 'alta6', label: 'Niños/Niñas · Alta 6' }
  ],
  ...
  // Escala de color para el coroplético de alertas (3 clases Natural Breaks,
  // tonos del azul institucional, de más claro a más intenso)
  ESCALA_COROPLETICO: ['#C7C4EA', '#7D76C9', '#2D2D93'],
