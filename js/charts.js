...
const Graficos = (() => {
  ...
  function actualizar(nivel, props) {
    ...
    // Cada etiqueta se parte en 2 líneas (Chart.js acepta un arreglo de
    // strings por etiqueta) en vez de rotar el texto, para que se lea
    // horizontal y completo aunque el nombre de la categoría sea largo.
    const etiquetas = CONFIG.CATEGORIAS_ALERTA.map(c => c.label.split(' · '));
